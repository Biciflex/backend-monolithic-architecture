...
import com.upc.biciflex.dto.UserDto;
import com.upc.biciflex.exception.ResourceNotFoundException;
import com.upc.biciflex.exception.ValidationException;
import com.upc.biciflex.model.User;
import com.upc.biciflex.repository.UserRepository;
import com.upc.biciflex.service.UserService;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/api/biciflex/v1/users")
public class UserController {
    ...
    // URL: http://localhost:8080/api/biciflex/v1/users
    // Method: GET
    ...
    // URL: http://localhost:8080/api/biciflex/v1/users/{userId}
    // Method: GET
    @Transactional(readOnly = true)
    @GetMapping("/{userId}")
    ...
    // URL: http://localhost:8080/api/biciflex/v1/login
    // Method: POST
    @Transactional(readOnly = true)
    @PostMapping("/login")
    ...
    // URL: http://localhost:8080/api/biciflex/v1/register
    // Method: POST
    @Transactional
