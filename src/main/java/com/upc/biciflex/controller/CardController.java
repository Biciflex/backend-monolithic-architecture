...
import com.upc.biciflex.service.CardService;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/api/biciflex/v1/cards")
public class CardController {
    ...
    // URL: http://localhost:8080/api/biciflex/v1/cards/{cardId}
    // Method: GET
    ...
    // URL: http://localhost:8080/api/biciflex/v1/cards/user/{userId}
    // Method: GET
    @Transactional(readOnly = true)
    ...
    // URL: http://localhost:8080/api/biciflex/v1/cards/{userId}
    // Method: POST
    @Transactional
    @PostMapping("/{userId}")
    ...
    // URL: http://localhost:8080/api/biciflex/v1/cards/{cardId}/main
    // Method: PATCH
    @Transactional
